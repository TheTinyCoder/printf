...
/**
 * print_decimal_space - writes a number to stdout assuming base 10
 * @args: va_list
 * @buf: buffer
 * @index: buffer index
...
int print_decimal_space(va_list args, char *buf, int index)
{
	int i = 0, j = 0, k = 0;
...
/**
 * print_integer_space - writes a number to stdout after converting to decimal
 * @args: va_list
 * @buf: buffer
 * @index: buffer index
 * Return: number of bytes printed
...
int print_integer_space(va_list args, char *buf, int index)
{
	int d = 0, f = 0;
